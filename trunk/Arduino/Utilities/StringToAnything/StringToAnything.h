...
||
|| @information
|| | This is a redundant release of the C++ library StringToAnything.
|| | There might be a newer version online.
|| | Please refer to: http://code.google.com/p/alexanderbrevig/source/browse/trunk#trunk/C++/Utilities/StringToAnything
|| #
||
|| @usage
